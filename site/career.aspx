<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="career.aspx.cs" Inherits="site.career" %>
						...
						<div class="container">
							<div class="row">
								<div class="col-xs-12  text-center">
										...
										<p class="text-white  text-center lineheight2 p20">We are looking for a motivated, talented and highly productive candidates to join our highly skilled team of professionals at the company's headquarters in Greece.</p>
										<p class="text-white  text-center p20">Send your CV to <a class="text-gold" href="mailto:hr@magna-trust.com" >hr@magna-trust.com</a></p>
								</div>
							</div>
						</div>
					</div>
