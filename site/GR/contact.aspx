<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="site.GR.contact" %>
...
<body>
 ...
 <section class="no-padding" id="section-home">
                        ...
                        <div class="imgText">
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-xs-offset-2  custmarg" style="margin-bottom: 135px;">
								  <div class="row">
                                    <h1 class="text-white text-center text-serif">ΕΠΙΚΟΙΝΩΝΙΑ</h1>
								  </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 padcontactleft">
                                     ...
                                     <div class="row"><h6 class="text-white text-center" style="color:#d6b588!important;">Κεντρικά Γραφεία</h6></div>
                                    <div class="row"><h6 class="text-white text-center">Τζωρτζ 5</h6></div>
                                    <h6 class="text-white text-center">Αθήνα, 10682,</h6>
                                    <h6 class="text-white text-center">Ελλάδα</h6>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 padcontactright">
				<h3 class="text-white text-center">ΕΠΙΚΟΙΝΩΝΗΣΤΕ ΜΑΖΙ ΜΑΣ</h3>
	     ...
	     <div class="col-xs-12 col-sm-12 col-md-6 padicons">
            <div class="form-group">
                 <select  class="form-control required" id="selTitle" type="text" name="title"  placeholder="" runat="server">
                        <option selected="selected" value="" disabled="">Διαλέξτε Τίτλο</option>
			...
			<div class="form-group">
                ...
                <input id="name" class="form-control required" type="text" name="name" placeholder="'Ονομα" runat="server"/>
               
            </div>
			
			<div class="form-group">
                
                <input id="lname" class="form-control required" type="text" name="lname"  placeholder="Επίθετο" runat="server"/>
	     ...
	     <div class="col-xs-12 col-sm-12 col-md-6 padicons">			
            <div class="form-group">
                ...
                <input id="countrycode" class="form-control  required" type="text" name="countrycode"
                       placeholder="Κωδικός Χώρας | Τηλέφωνο" runat="server"/>
            </div>
			
			 <div class="form-group">
                <input id="subject" class="form-control  required" type="text" name="subject" placeholder="Θέμα" runat="server"/>
            </div>
            ...
            <div class="form-group">
				...
				<textarea id="message" class="form-control required" name="message"  placeholder="Μήνυμα" runat="server"></textarea>
			...
			<div class="col-xs-12 col-md-4 pull-left text-white paddspan">
			*όλα τα πεδία είναι υποχρεωτικά
			</div>
			<div class="col-xs-12 col-md-4 pull-right">
			<input type="submit" name="btnSubmit" value="ΥΠΟΒΟΛΗ" id="btnSubmit" class="btn btn-md btn-gold text-uppercase" runat="server" onserverclick="btnSubmit1_Click">
			</div>
			</div>
									...
									<div id="thank-you" class="row p20" style="display: none;">
										<div class="col-sm-8 col-sm-offset-2 text-center">
											<h6 class="text-center text-white">Σας ευχαριστούμε για το μήνυμά σας. Προσπαθούμε να απαντάμε σε όλα τα μηνύματα το συντομότερο δυνατόν. Εν τω μεταξύ μπορείτε να μας καλέσετε και στο (+30) 2103800820 - θα χαρούμε να σας εξυπηρετήσουμε!</h6>
