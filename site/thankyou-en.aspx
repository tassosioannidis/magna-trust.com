...
<body>
 ...
 <section class="no-padding" id="section-home">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 padcontactright" style="min-height: 500px;">
				<div id="thank-you" class="row" style="padding-top: 100px!important;">
					<div class="col-sm-8 col-sm-offset-2 text-center">
						<h6 class="text-center text-gold">Thank you for your message. We endeavour to reply to all inquiries within the shortest time frame possible. In the meantime, you can call us at (+30) 2103800820 and we will be glad to be of assistance.</h6>
