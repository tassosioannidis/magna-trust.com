...
<body>
 ...
 <section class="no-padding" id="section-home">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 padcontactright">
				<h5 class="text-white text-center">Submit an enquiry for Athens Stock Exchanges</h5>
				<p class="text-white text-center">A member of our staff will reply to you as soon as possible</p>
