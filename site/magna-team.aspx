						...
						<div class="container">
							<div class="row">
								<div class="col-xs-12  text-center">
										<h1 class="text-white  text-center text-serif">MAGNA TEAM</h1>
										<p class="text-white  text-center ">Magna Trust has a team of qualified professionals and executives from the financial industry, providing bespoke services at international level for over 15 years</p>
            ...
            <div class="container">
				...
				<div class="row">
					<div class="col-sm-6">
						<h2 class="blue_line text-left">Dr. Tsakiris Ioannis</h2>
							<h4 class="text-left text-bold">Chairman</h4>
					...
					<div class="col-sm-6 ">
                        <h2 class="blue_line text-left">Vasilis Tsaprounis</h2>
							...
							<hr align="center" class="blue-hr visible-xs" >-->
							<p class="text-left">
							With a background in Math and Finance and over 18 years of professional experience in Capital Markets, Vasilis holds today one of the most successful track records in the field, both professionally and academically.</p>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<h4 class="text-left text-bold"> CEO</h4>
						<p class="text-left">
						Charalampos studied Accountancy (DIDACTA Accountant, Interface Business &amp; Information Training, Athens Derivatives Exchange).
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<p class="text-left">
							...
							<p>Alexandros works for Benteniotis Law Office, one of the leading law offices in Greece. </p>
